...
import { Button, Subtitle, Text, LoadingSpinner } from '@/components/ui';
...
const AdminContent = () => {
    ...
    return (
        <main className="flex h-full w-[90%] flex-1 flex-col gap-8 bg-slate-100 p-4 lg:ml-64 lg:p-8">
...
const Admin = () => {
    return (
        <Suspense
            fallback={
                <div className="flex h-full w-[90%] flex-1 flex-col gap-8 bg-slate-100 p-4 lg:ml-64 lg:p-8">
                    <div className="flex min-h-[60vh] items-center justify-center">
                        <LoadingSpinner size={48} label="Cargando dashboard..." />
                    </div>
                </div>
            }>
            <AdminContent />
